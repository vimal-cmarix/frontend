 ...
 * Private Link Modal
 */
const PrivatePitchJob = ({ data, onClose }) => {
  ...
  const text = `
    <span>
      ${data.type === 'private' ? 'URL:' : ''} ${urlGenerate()}
    </span>
   ${
     data.secret && data.type === 'private'
       ? `
      <span>
        Pass: ${data.secret}
      </span>
...
PrivatePitchJob.propTypes = {
  data: PropTypes.oneOfType([PropTypes.object]).isRequired,
  onClose: PropTypes.func,
};

PrivatePitchJob.defaultProps = {
  onClose: false,
};

export default PrivatePitchJob;
