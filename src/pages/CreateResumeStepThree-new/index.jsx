        ...
        <BoxFormWrap>
          <Form onSubmit={handleSubmit} ref={formRef}>
            <CreateResume className="createresume">
              <BoxFormTitle>
                <h2>3 of 5: Add Work Experience</h2>
              </BoxFormTitle>

              <EductionWrap>
                <div className="add_education inner_block">
                  <h4 className="common_ttl">Work Experience</h4>
                  <EducationOneThree>
                    <div className="education-one">
                      <div className="form-group">
                        <h5 className="job-ttl">Job Title</h5>
                        ...
                        <p className="breifing">
                          ...
                          elit. Purus id pellentesque duis nisl vitae ut id.
                          Integer mattis sem fermentum diam tincidunt porttitor
                          blandit. Nam iaculis accumsan aliquet volutpat id nisl
                          rhoncus diam. Semper.
                        </p>
                      </div>
                    </div>
              ...
              <FormWrapperBlock className="form-group">
                ...
                >
                  <TextInput
                    ...
                    size="medium"
                    maxLength="30"
                    placeholder={t('form.placeholder.jobTitle')}
                    onChange={handleChange}
                  />
                </FormBlock>
              </FormWrapperBlock>
              <FormWrapperBlock className="form-group">
                <FormBlock className="reqlabel" label={t('form.label.Company')}>
                  <TextInput
                    className="form-control"
                    name="Company"
                    size="medium"
